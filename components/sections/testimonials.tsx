...
const testimonials = [
  {
    quote:
      "Social Media Marketing & Multi‑Channel Outreach, We provide a full‑service outreach solution that blends Web3 & Web2 strategies, Real Estate campaigns, Business development, Direct Email marketing, Lead scraping, and expert Outreach Management. Our system is built to generate qualified leads, secure booked meetings, and drive measurable growth. By combining advanced social media marketing with proven cold email systems, we ensure your brand connects with the right audience. With us, outreach isn’t just activity — it’s a strategic partnership designed to convert, scale, and deliver results.",
